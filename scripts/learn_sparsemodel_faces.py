...
l = SGD(model=SparseSlowModel(patch_sz=48,N=1024,T=48,sparse_cost='elastic',slow_cost=None,lam_sparse=0.1,lam_l2=1.0,perc_var=99.),datasource='YouTubeFaces_aligned',display_every=20000,batchsize=48)
